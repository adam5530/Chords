	...
	, isBare{false}
{
	...
	chords[0][0] = "C  01023x  "; chords[0][1] = "c  34553xb3"; chords[0][2] = "C7 01323x  "; chords[0][3] = "c7 34353xb3";
	chords[1][0] = "C# 46664xb4"; chords[1][1] = "c# 45664xb4"; chords[1][2] = "C#746464xb4"; chords[1][3] = "c#745464xb4";
	chords[2][0] = "D  2320xx  "; chords[2][1] = "d  1320xx  "; chords[2][2] = "D7 2120xx  "; chords[2][3] = "d7 1120xx  ";
	chords[3][0] = "D# 68886xb6"; chords[3][1] = "d# 67886xb6"; chords[3][2] = "D#768686xb6"; chords[3][3] = "d#766686xb6";
	...
	chords[9][0] = "A  02220x  "; chords[9][1] = "a  01220x  "; chords[9][2] = "A7 02020x  "; chords[9][3] = "a7 01020x  ";
	chords[10][0] = "B  13331xb1"; chords[10][1] = "b  12331xb1"; chords[10][2] = "B7 13131xb1"; chords[10][3] = "b7 12131xb1";
	chords[11][0] = "H  24442xb2"; chords[11][1] = "h  23442xb2"; chords[11][2] = "H7 24242xb2"; chords[11][3] = "h7 23242xb2";
...
void Guitar::drawStrings()
{
	...
	for (int i = 0; i < 6; ++i) //strings E A D G H e
	{
		for (int j = 0; j < 8; ++j) //thresholds 1 2 3 4 5 
		{
			...
			if ((isBare == true) && (j == numberBare - 1) && (numberOfString[i] != -10))
...
void Guitar::setDefaultParameters()
{
	...
	numberOfString[3] = 1; numberOfString[4] = 2; numberOfString[5] = -10;
}